...
\quad In this section, we study the case when the player do not make any
assumption on the adversary policy by looking for policies that could suit with
"any" adversary. Here we accept quite lower maximum score if it make
the minimal score (over all adversary policies) is higher.

Our first idea at this end is
