    ...
    \begin{itemize}
      \item \textbf{Lowest Maximal Reward (Min-Max)}:
        ...
        \begin{equation*}\tiny
          ...
          P(s'|s,a,t) \cdot \left( R(s') + \lambda V(s') \right)
        \end{equation*}
...
\begin{frame}
  ...
  \begin{block}{Approach 1: Max-Min Value Iteration}
    ...
    \\
    \begin{equation*}
      V(s) = \max_{a \in A} \min_{t \in \{I,L\}} P(s' | s, a, t)
      \cdot \left( R(s, a, s') + \lambda V(s') \right)
    \end{equation*}
  \end{block}
...
\begin{frame}
  ...
  \begin{block}{Observations}
    \begin{itemize}
      \item Height Weight is Critical
      \item Score and Line Weights Matter
...
\begin{frame}
  ...
  \begin{itemize}
    \item Developed MDP models and value iteration for player, adversary, and robust Baby Tetris policies.
    \item Improved efficiency with reachable states, enhancing policy analysis.
    \item Robust policies provide strong performance against various adversaries.
    \item Key drivers for good policy: prioritize line clears/score and avoid height penalties.
  \end{itemize}
\end{frame}
