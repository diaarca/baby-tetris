...
public abstract class Tromino {
     ...
     * Rotation indices normalize internally (e.g. IPiece has 2 unique rotations).
     * Each offset is an int[]{rowOffset, columnOffset}.
     */
    ...
    public static class IPiece extends Tromino {
        @Override
        public int rotationCount() { return 2; }
    ...
    public static class LPiece extends Tromino {
        ...
        public int[][] getOffsets(int rotation) {
            ...
            // Represent the L-shaped tromino as one of the four 2x2 boxes with one missing cell.
            switch (r) {
                // missing top-left
                case 0: return new int[][]{{0,1},{1,0},{1,1}};
                // missing top-right
                case 1: return new int[][]{{0,0},{1,0},{1,1}};
                // missing bottom-right
                case 2: return new int[][]{{0,0},{0,1},{1,0}};
                // missing bottom-left
                default: return new int[][]{{0,0},{0,1},{1,1}};
            }
        }
    }
}
