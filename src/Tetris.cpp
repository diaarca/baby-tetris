...
int main()
{
    ...
    */
    ...
    // setting the best found parameters
    double best_line_weight = 10.0;
    double best_height_weight = 1.0;
    double best_score_weight = 2.0;

    // --- Final Comparison with Best Weights ---
    std::cout << "--- Running Comparison with Best Weights ---" << std::endl;
    ...
    std::cout << "\n--- Final Results for Best Full Feature Policy ---"
              << std::endl;
    std::cout << "Random Adversary: " << final_rand_score / NB_SIMU
              << std::endl;
