...
\subsection{Executions}
\quad The following table presents selected results from our grid search experiments for the parameterized policy and the performance of the dedicated Max-Min VI policy.
